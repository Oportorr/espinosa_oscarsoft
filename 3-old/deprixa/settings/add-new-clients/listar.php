...
include('../../database-settings.php');
  ...
  $resultado = $con->query("SELECT tc.id, tc.name, tc.address, tc.phone, tc.email, tc.estado, c.country_name, s.state_name FROM tbl_clients tc LEFT JOIN country c ON tc.country = c.country_id LEFT JOIN state s ON s.state_id = tc.state");
