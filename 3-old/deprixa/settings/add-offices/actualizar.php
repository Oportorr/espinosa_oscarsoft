...
elseif(empty($contact_person)){
	...
	$consulta = "UPDATE offices SET off_name='$off_name', address='$address', city='$city', ph_no='$ph_no', office_time='$office_time', contact_person='$contact_person', estado='$estado' , line_shipping_status_id='$status' WHERE id='$id'";
	else{
