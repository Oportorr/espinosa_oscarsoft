...
elseif(empty($container_notes)){
	...
	$consulta = "UPDATE courier_container SET container_number='$container_number', container_description='$container_description', container_notes='$container_notes' WHERE container_id='$id'";	
