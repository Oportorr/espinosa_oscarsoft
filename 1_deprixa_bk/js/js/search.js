...
"columnDefs":[{// insertamos las operaciones en la posición 5 al final de la tabla
                ...
                "render": function (data, type, full) { // renderisado de datos creamos los botones de editar, estado y eliminar
                  ...
                  return '<a data-toggle="tooltip" title="Invoice Print" target="_blank" href="print-invoice/invoice-print-old.php?cid='+full['cid']+'" target="_blank"> <img src="images/print.png"  height="20" width="20"> </a>' ;
                  
                }
            },
    
            {// insertamos las operaciones en la posición 5 al final de la tabla
                "targets": [1],
                "data": "balance, cid", // campo a recuperar en esta columnas id del usuario
                
                "render": function (data, type, full) { // renderisado de datos creamos los botones de editar, estado y eliminar
                 
                    return '<a href="edit-courier.php?cid='+full['cid']+'" class="open-pay" target="_blank">'+full['invoice_number']+'</a>' ;
            ...
            {// insertamos las operaciones en la posición 5 al final de la tabla
                ...
                "render": function (data, type, full) { // renderisado de datos creamos los botones de editar, estado y eliminar
                    ...
                    return '<a href="javascript:;" data-toggle="modal" data-target="#nuevo" data-id="'+full['cid']+'" class="open-pay">'+full['balance']+'</a>' ;
                }
                }
            }        
        ], 
