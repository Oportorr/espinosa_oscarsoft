...
<!--							    <select name="product[0][product_type]"  id="product_type" required class="product_type form-control">
							...
							<td><input  type="text" class="form-control discount" id="discount10"  name="product[0][discount]" placeholder="%" onChange="" style="width:60px;" /> </td>
                                                        <td><input  type="text" readonly="true" class="form-control sub_total" value="0"  id="sub_total10"  name="product[0][sub_total]" style="width:90px;" placeholder="0,00" onChange="" /></td>	
                                                        <td>&nbsp;</td>
...
<?php //} ?>
	...
	//	html += '<input  type="hidden" id="product_price' + row + '" class="product_price" name="product[' + row + '][product_price]	" value=""/>';
		...
		html += '<td><input  type="text" style="width:60px;" class="form-control discount" id="discount' + row + '"  name="product[' + row + '][discount]" placeholder="%" onChange=""/></td>';
		html += '<td><input  type="text" readonly="true" class="form-control sub_total" id="sub_total' + row + '"  name="product[' + row + '][sub_total]" style="width:90px;" placeholder="0,00" onChange="" /></td>';
