...
?>
<?php
$thmlhead = '<h2><p style="text-align:center;" >Container Sender Details Listing Report</font></p></h2>';
$html = '<table cellpadding="0" cellspacing="0" border="1" width="100%"><tr>';
$html .='<td align="center" style="font-family: serif; font-size: 25px;font-weight: bold;">Container number</td>';
$html .='<td align="center" style="font-family: serif; font-size: 25px;font-weight: bold;">invoice_number</td>';
...
while ($row = mysql_fetch_array($getresult)) {
		$html .='<tr><td height="80px" width="50px" style="text-align: center; font-family: serif; font-size: 25px;">' . $row['container_number'] . '</td>';
		$html .='<td width="100px" style="text-align: center; font-family: serif; font-size: 25px; ">'.$row['invoice_number'] . '</td>';
