...
if ($count > 0) {
    while ($data = dbFetchAssoc($result)) {
                                                ...
                                                <fieldset class="col-md-6">
                                                    ...
                                                    <div class="row" >
                                                        <div class="col-sm-5 form-group">
                                                            ...
                                                            <input type="text"  name="Shipperaddress" id="Shipperaddress" class="form-control" required value="<?php echo $s_add; ?>" >
                                                        </div>
                                                        <div class="col-sm-3 form-group">
                                                            <label  class="control-label"><i class="fa fa-phone icon text-default-lter"></i>&nbsp;PHONE</label>                            
                                                            <input type="text" class="form-control" id="Shipperphone" name="Shipperphone" required value="<?php echo $phone; ?>">
                                                        </div>

                                                        <div class="col-sm-4 form-group">
                                                            <label class="control-label">ID</i></label>
                                                            <input type="text" name="Shippercc" id="Shippercc" class="form-control"  value="<?php echo $cc; ?>" readonly="true"  required>
                                                        </div>									
                                                    </div>	
                                                    ...
                                                    <div class="row" >
                                                        <div class="col-sm-4 form-group">
                                                            ...
                                                            <select name="city" required id ="city" class="city form-control">
                                                                ...
                                                                <?php
                                                                $stmt = mysql_query("SELECT * FROM city where state_id='" . $state_id . "'");
                                                                while ($row_city = mysql_fetch_array($stmt)) {
                                                                    ?>
                                                                    <option value="<?php echo $row_city['city_id']; ?>" <?php
                                                                    if ($row_city['city_id'] == $s_city) {
                                                                        echo "selected";
                                                                    }
        ...
        <?php } ?>
                                 ...
                                 <!--<input name="Bookingmode" class="form-control"  id="Bookingmode" value="<?php echo $book_mode; ?>" readonly="true">-->                                                 <select name="Bookingmode"  class="form-control">
                                                                <option value="Paid" <?php if($book_mode=='Paid'){ echo "selected"; } ?> >Paid</option>
                                                                <option value="Partial" <?php if($book_mode=='Partial'){ echo "selected"; } ?>>Partial</option>
                                                                <option value="Pending" <?php if($book_mode=='Pending'){ echo "selected"; } ?>>Pending</option>
                                                            </select>
                                                   </div>
...
// $getdd = mysql_fetch_array(mysql_query("SELECT `id`,`off_name` FROM `offices` where id='$invice_no'"));
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="table-product" class="table table-striped table-bordered" cellspacing="0">
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        <th style="width: 70%">PRODUCT TYPE</th>
            ...
            <?php //}  ?>
                                                                        ...
                                                                        <td><input  type="text" id="product_price"  style="width:60px;"  class="form-control product_price" name="product[<?php echo $product_row; ?>][product_price]" value="<?php echo $item['product_price']; ?>" required="required"/> </td>

                                                                        <td><input  type="text"  class="form-control ship_qty" id="ship_qty"  name="product[<?php echo $product_row; ?>][ship_qty]" style="width:40px;" value="<?php echo $item['ship_qty']; ?>" placeholder="0" onChange=""/></td>
                                                                        <td><input  type="text" class="form-control discount" id="discount1"  name="product[<?php echo $product_row; ?>][discount]" style="width:50px;"  value="<?php echo $item['discount']; ?>" placeholder="" onChange=""/></td>
                                                                        <td><input  type="text" readonly="true" style="width:75px;" class="form-control sub_total"  id="sub_total1"  name="product[<?php echo $product_row; ?>][sub_total]" value="<?php echo $item['sub_total']; ?>" placeholder="0,00" onChange="" /></td>

                                                                        <td><button type="button" class="btn btn-danger delete_btn" onclick="deleteRow(this)"/><i class="fa fa-trash"></i></button>  </td>
                                                                        <td>                                                                            
                                                                            <select name="product[<?php echo $product_row; ?>][ship_status]" value="<?php echo $row['id']; ?><?php echo $row['status']; ?>" style="width:95px;" id="ship_status" required class="status form-control ship_status" value="" >
        ...
        <?php } ?>
                                                            ...
                                                            <div class="col-sm-custom form-group">
                                                                <div class="text-center">
                                                                    <?php
                                                                    $courier_item = mysql_query("SELECT * FROM courier WHERE cid ='$cid'");
                                                                    while ($item = mysql_fetch_array($courier_item)) {
                                                        ...
                                                        <div class="col-sm-12 form-group">
                                                            ...
                                                            <input class="form-control" style="color:red;" name="Comments" id="Comments" value="<?php echo $comments; ?>">
                                                        </div>
                                                    </div>
                                                </fieldset>
                                                ...
                                                <fieldset class="col-md-6">
                                                    ...
                                                    <div class="row">
														...
														<select name="Receivername_select" id="GetReceivername" required="" class="form-control">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 form-group">
                                                            <label  class="control-label">ADDRESS <span class="required-field">*</span></label>
                                                            <input type="text"  name="Receiveraddress" id="Receiveraddress" class="form-control"  required value="<?php echo $r_add; ?>">
                                                        </div>

                                                        <div class="col-sm-3 form-group">
                                                            <label  class="control-label"><i class="fa fa-phone icon text-default-lter"></i>&nbsp;PHONE</label>
                                                            <input type="text" class="form-control" name="Receiverphone" id="Receiverphone" required value="<?php echo $r_phone; ?>">
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4 form-group">
                                                            ...
                                                            <select name="city1" required id ="city1" class="city1 form-control">
                                                                <option>Select city</option>
        <?php
        $stmt = mysql_query("SELECT * FROM city where state_id='$state_id1'");
        while ($row_edit_city = mysql_fetch_array($stmt)) {
            ?>
                                                                    <option value="<?php echo $row_edit_city['city_id']; ?>" <?php
            if ($row_edit_city['city_id'] == $r_city) {
                echo 'selected';
            }
            ?>><?php echo $row_edit_city['city_name']; ?></option>
        <?php } ?>
        ...
        <?php } ?>
                                                            ...
                                                            <input type="text" name="cedula_number" id="cedula_number" class="form-control" value="<?php echo $r_cedula_number; ?>">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 form-group">
                                                            ...
                                                            <div>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control edit-courier-dates" name="Packupdate" placeholder="mm/dd/yyyy" id="editdatepicker">
                                                        ...
                                                        <div class="col-sm-6 form-group">
                                                            ...
                                                            <div>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control edit-courier-dates" value="<?php echo $payment_due; ?>" name="Payment_Due" id="payment_due" placeholder="mm/dd/yyyy" >
                                                                    <span class="input-group-addon bg-custom b-0"><i class="icon-calender"></i></span>
                                                                </div><!-- input-group -->
                                                            </div>
            ...
            while ($newrs = mysql_fetch_array($rs)) {
                ...
                ?>
                                                                        <option value="<?php echo $firstdata . ',' . $dataid; ?>" <?php if ($firstdata == $secondata) {
                    echo "selected";
                } ?> > <?php echo $firstdata; ?> </option>
        ...
        <?php } ?>
                                                        ...
                                                        <div class="col-sm-3 form-group">
                                                            ...
                                                            <div>
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control edit-courier-dates" name="Schedule" value="<?php echo $schedule; ?>"  id="datepicker">
                                                                    <span class="input-group-addon bg-custom b-0"><i class="icon-calender"></i></span>
                                                                </div><!-- input-group -->
                                                            </div>		
                                                        </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" action="process.php?action=add-pay2"  class="form-horizontal" id="payment">
                                            <div class="form-group " id="gnombre">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control edit-courier-dates" name="date" placeholder="mm/dd/yyyy" id="payment_date">
    ...
    ?>
			...
			<script>
		     ...
		     $('#GetReceivername').on('change', function() {
				...
				var id1,name1,address1,email1,phone1,password1,company1,country1,state1,city_name1,cedula1;
            ...
            <script type="text/javascript">
                                                    $(function () {
                                                        var id, name, address, email, phone, password, company, country, email, state, city_name, zipcode, cedula1;
    //autocomplete
   ...
   function getReci(str){
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('.edit-courier-dates').datetimepicker({
                        todayBtn: 'linked',
                        todayHighlight: true,
...
<?php } ?>
    ...
    <SCRIPT language="javascript">
        ...
        function addRow(tableID) {
            ...
            html += '<td><input required="required"  style="width:60px;" type="text" id="product_price' + row + '" class="form-control product_price" name="product[' + row + '][product_price]"/></td>';
            html += '<td><input  type="text"  style="width:40px;" class="form-control ship_qty" id="ship_qty' + row + '"  name="product[' + row + '][ship_qty]" placeholder="0" onChange=""/></td>';
            html += '<td><input  type="text" class="form-control discount" id="discount' + row + '"  name="product[' + row + '][discount]" placeholder="" style="width:50px;" onChange=""/></td>';
            html += '<td><input  type="text" readonly="true"  class="form-control sub_total"  id="sub_total' + row + '"  style="width:75px;" name="product[' + row + '][sub_total]" placeholder="0,00" onChange="" /></td>';
            html += '<td><button type="button" class="btn btn-danger delete_btn" onclick="deleteRow(this)"><i class="fa fa-trash"></i></button>  </td>';


            html += '<td><select name="product[' + row + '][ship_status]" style="width:95px;" value="<?php echo $row['id']; ?><?php echo $row['status']; ?>" id="ship_status' + row + '" required class="status form-control ship_status" value="" >';

<?php
$stmt = mysql_query("SELECT `off_name`,`id` FROM `offices` where `estado`=1 ");
while ($row = mysql_fetch_array($stmt)) {
    ?>
                html += '<option value="<?php echo $row['id']; ?>" <?php if ($row['id'] == $item['line_shipping_status']) {
        echo "selected";
    } ?> ><?php echo $row['off_name']; ?></option>';
<?php } ?>
            html += '</select></td>';
