...
include('../../database-settings.php');
  ...
  $resultado = $con->query("SELECT container_id as id, container_number, container_description, container_date, container_notes,container_status FROM courier_container");
