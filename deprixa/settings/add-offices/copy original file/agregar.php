...
if(isset($_POST['head_office_assign']))
$head_office = $_POST['head_office_assign'];
else
$head_office = 0;
...
$consulta = "INSERT INTO offices (off_name,address,city,ph_no,office_time,contact_person,head_office,estado) VALUES('$off_name','$address','$city','$ph_no','$office_time','$contact_person','$head_office','$estado')";
