...
elseif(empty($work)){
	echo json_encode(array('msg' => 'work_msg'));
	exit();
}
elseif(empty($cell)){
	echo json_encode(array('msg' => 'cell_msg'));
	exit();
}
//elseif(empty($email)){
...
// }
	...
	//$consulta = "UPDATE tbl_clients SET name='$name',  address='$address', email='$email', phone='$phone', password='$password', estado='$estado' WHERE id='$id'";	
	//}
	$consulta = "UPDATE tbl_clients SET name='$name',  address='$address', email='$email', phone='$phone', work='$work', cell='$cell', password='$password', country='$country', state='$state', city='$city', zipcode='$zipcode', cedula_no = '$cedula_no', estado='$estado' WHERE id='$id'";
  }
