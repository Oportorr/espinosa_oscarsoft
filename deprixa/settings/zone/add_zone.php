...
$zone = "INSERT INTO zone (name, description, country, zone_status, created_date) VALUES('$zone_name','$description','$country', $estado, '$created_date')";
...
if($con->query($zone)){
    ...
    foreach($_POST['state'] as $srow){
        $sres = "INSERT INTO zone_state (zone_id, state_id, created_date) VALUES('$zone_id', '$srow', '$createdDate')";
        $con->query($sres);
    }
    foreach($_POST['city'] as $crow){
        $cres = "INSERT INTO zone_city (zone_id, city_id, created_date) VALUES('$zone_id', '$crow', '$createdDate')";
        $con->query($cres);
    }
}
