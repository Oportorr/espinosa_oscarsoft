...
$q = "SELECT zone_status FROM zone WHERE id='$id'";
...
if($estado['zone_status'] == '1'){
	// Cambiamos el estado a inactivo
	$q = "UPDATE zone SET zone_status='0' WHERE id='$id'";
}
else{
	// Cambiamos el estado a activo
	$q = "UPDATE zone SET zone_status='1' WHERE id='$id'";
}
