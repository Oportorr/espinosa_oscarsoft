...
require_once('../../database.php');
	...
	$sql1 =mysql_query("SELECT email,name FROM manager_user WHERE email='$email' OR name='$name'");
			if($row=mysql_fetch_array($sql1)){							
				...
				$sql1="INSERT INTO manager_user (name_parson,name,email,phone,office,role,pwd,estado,flag,type,date) VALUES 	
				('$name_parson','$name','$email','$phone','$office','$role','$pwd','$estado','$flag','$type',curdate())";
			}
	dbQuery($sql1);
