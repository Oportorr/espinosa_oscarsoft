...
$country2 = mysql_query("SELECT country_name FROM country WHERE country_id = '$r_country'");
 ...
 $sql5 = mysql_query("SELECT mu.flag, mu.phone, mu.name, c.officename,c.invoice_number FROM manager_user mu LEFT JOIN courier c ON (mu.name = c.officename) WHERE c.cid = $cid ");
...
<tr>
	...
	<!--
		<tr>
		<td style="font-size: 14px;">  <b>Order ID:</b> <?php echo $invoice_number; ?>  </td>
	</tr> -->
...
<tr>
	<td style="vertical-align: top; border:solid 1px #000; padding: 5px 10px;">
		<table style="width: 100%; text-align: center; vertical-align: top;">
			...
			<tr>
		<!--<td style="font-size: 18px;">  <b>Order ID:</b> <?php echo $invoice_number; ?>  </td> -->
		<td style="font-size: 18px;"> <b>Order ID:</b> <b><u><?php echo $invoice_number; ?></u></b> </td>
</td>
				<tr>
					<td style="font-size: 14px;"> <b>Contenedor:</b> <b><?php echo $container_number; ?></b> </td>
				</tr>
	</tr>
			
			<tr>
				<td style="font-size: 12px;font-weight: bold;"> <?php echo $rev_name; ?>  </td>
			</tr>
			<tr>
				<td style="font-size: 12px;font-weight: bold;"> <?php echo $r_phone; ?></td>
			</tr>
			<tr>
				<td style="font-size: 12px;font-weight: bold;"> <?php echo $r_add; ?></td>
			</tr>
				<!-- Modified by OP -->
			 <tr>
...
<tr>
	<td style="font-size: 12px; font-weight: bold; padding:15px 0 0px 0px; text-align: left; ">
                                                    <center>
