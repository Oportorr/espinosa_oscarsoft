    ...
    $(document).on("click", '.editar', function (event) {
        ...
        $.ajax({// configuraciÃ³n de ajax
            ...
            if (data[0]['default_origin'] == '1') { // default_origin
                 ...
                 $('#head_office_edit').attr('checked','checked');
             //$('#formularioEditar input[name="hid_head_office"]').attr('checked','checked');     
              
               
            } else {
              $('#head_office_edit').removeAttr('checked',false);
           
              //$('#formularioEditar input[name="hid_head_office"]').removeAttr('checked',false);  
            }
