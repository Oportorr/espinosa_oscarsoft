...
//var datos = $('#formularioNuevo').serialize();	// recuperamos todos los campos del formulario
    $.ajax ({ // configuraci{on de ajax
            type: "POST",
            url: "settings/zone/add_zone.php",
            data: {zone_name:zone_name, description:description, country:country, state:state, city:city, estado:check },
            dataType:"html"
        }).done(function(data){
                ...
                switch(data.msg){
                    ...
                    notificar("The zone was successfully registered in the database.","ok");
                    //recargamos la tabla
                    treload.ajax.reload();
                    ...
                    case 'apevacio':
                    notificar("Error the description field is required.","error");
                    //añadimos una clase error al campo nombre
                    ...
                    case 'country':
                    notificar("Error the country field is required.","error");
                    //añadimos una clase error al campo nombre
                    $('#addCountry').addClass('has-error');

                    break;	
                
                    case 'telvacio':
                    notificar("Error the state field is required.","error");
                    //añadimos una clase error al campo nombre
                    $('#addState').addClass('has-error');
