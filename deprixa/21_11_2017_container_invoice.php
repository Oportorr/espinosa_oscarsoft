...
if (isset($_POST['submit'])) {
    ...
    if (!empty($getdata)) {
        $rs = " SELECT cid,invoice_number,ship_name,rev_name, container_number FROM `courier` WHERE container_id='$getdata' ";
    } else {
        $rs = " SELECT cid,ship_name,invoice_number,rev_name, container_number FROM `courier` ";
    }
}
?>
<!DOCTYPE html>
