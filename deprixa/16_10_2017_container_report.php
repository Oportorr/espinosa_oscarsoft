                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">                            
                            ...
                            <!-- ========================= End my Code========================= -->
                            <a class="btn btn-md print-btn btn-secondary"  href="container_pdf.php?select_container_num=<?php echo $select_container_num; ?>&bookingmode=<?php echo $bookingmode; ?>&username=<?php echo $username; ?>" target="_blank" >Print</a>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $rs = " SELECT c.cid,c.invoice_number,c.ship_name,c.s_zipcode,c.comments,c.s_add,c.paid_amount,c.shipping_subtotal,c.paid_amount, ct.city_name , st.state_name , co.country_name FROM `courier` c
