...
<html>
    ...
    <head>
        ...
        <style> .Paid { background: #675F99; } .ToPay { background: #FF8441; } .Cash-on-Delivery { background: #F6565A; } .Partial{ background: #f1b53d; } .Shipment-arrived { background: #FFC734; } .Returned { background: #F6565A; } .Pending { background: #FF5D48; } .Bank { background: #999; } .Paypal { background: #4DD2FF; }</style>
        <link href="assets/plugins/switchery/switchery.min.css" rel="stylesheet" />
                    ...
                    if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'Administrator') {
								...
								FROM courier WHERE  book_mode='Cash-on-Delivery' GROUP BY book_mode");
                                    while ($rr = mysql_fetch_array($sql))
                                        for ($i = 0; $i < mysql_num_fields($sql); $i++)
                                            echo $rr[$i] . " ";
                                    echo "<br>";
                                    ?></span> <span class="text-muted">Cash-on-Delivery</span>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-2">
                            <div class="card-box tilebox-one cl-box">
                                ...
                                <h2 class="m-b-20"><?php echo $company['currency']; ?><span data-plugin="counterup"><?php
                                        $result = mysql_query("SELECT SUM(shipping_subtotal	) as total FROM courier WHERE book_mode='Paid' AND status != 'Delivered'");
                                        $row = mysql_fetch_array($result, MYSQL_ASSOC);
                                        echo $s . formato($row["total"]);
                                        ?></span></h2>
                                <span class="label label-danger">
                                    <?php
                                    $sql = mysql_query("SELECT concat(round(count( * ) *100 /(SELECT count( * ) FROM courier)) , \"%\") AS percent
								FROM courier WHERE  book_mode='Paid' AND status != 'Delivered' GROUP BY book_mode");
                                    while ($rr = mysql_fetch_array($sql))
                                        for ($i = 0; $i < mysql_num_fields($sql); $i++)
                                            echo $rr[$i] . " ";
                                    echo "<br>";
                                    ?></span> <span class="text-muted">Paid</span>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card-box tilebox-one cl-box">
                                ...
                                <h2 class="m-b-20"><?php echo $company['currency']; ?><span data-plugin="counterup"><?php
                                        $result = mysql_query("SELECT SUM(shipping_subtotal	) as total FROM courier WHERE book_mode='Pending'");
                                        $row = mysql_fetch_array($result, MYSQL_ASSOC);
                                        echo $s . formato($row["total"]);
                                        ?></span></h2>
                                <span class="label label-pink">
                                    <?php
                                    $sql = mysql_query("SELECT concat(round(count( * ) *100 /(SELECT count( * ) FROM courier)) , \"%\") AS percent
								FROM courier WHERE  book_mode='Pending' GROUP BY book_mode");
                                    while ($rr = mysql_fetch_array($sql))
                                        for ($i = 0; $i < mysql_num_fields($sql); $i++)
                                            echo $rr[$i] . " ";
                                    echo "<br>";
                                    ?>	 </span> <span class="text-muted">Pending</span>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card-box tilebox-one cl-box">
                                ...
                                <h2 class="m-b-20"><?php echo $company['currency']; ?><span data-plugin="counterup"><?php
                                        $result = mysql_query("SELECT SUM(shipping_subtotal	) as total FROM courier WHERE book_mode='Partial'");
                                        $row = mysql_fetch_array($result, MYSQL_ASSOC);
                                        echo $s . formato($row["total"]);
                                        ?></span></h2>
                                <span class="label label-warning">
                                    <?php
                                    $sql = mysql_query("SELECT concat(round(count( * ) *100 /(SELECT count( * ) FROM courier)) , \"%\") AS percent
								FROM courier WHERE  book_mode='Partial' GROUP BY book_mode");
                                    while ($rr = mysql_fetch_array($sql))
                                        for ($i = 0; $i < mysql_num_fields($sql); $i++)
                                            echo $rr[$i] . " ";
                                    echo "<br>";
                    ...
                    if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'Employee') {
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-2">
                            <div class="card-box tilebox-one cl-box">
                                ...
                                <h6 class="text-muted text-uppercase m-b-20">Paid</h6>
                                <h2 class="m-b-20"><?php echo $company['currency']; ?><span data-plugin="counterup"><?php
                                        $result = mysql_query("SELECT SUM(shipping_subtotal	) as total FROM courier WHERE book_mode='Paid' AND user='" . $_SESSION["user_type"] . "' AND status != 'Delivered'");
                                        $row = mysql_fetch_array($result, MYSQL_ASSOC);
                                        echo $s . formato($row["total"]);
                                        ?></span></h2>
                                <span class="label label-danger">
                                    <?php
                                    $sql = mysql_query("SELECT concat(round(count( * ) *100 /(SELECT count( * ) FROM courier)) , \"%\") AS percent
								FROM courier WHERE  book_mode='Paid' AND status != 'Delivered' AND user='" . $_SESSION["user_type"] . "' GROUP BY book_mode");
                                    while ($rr = mysql_fetch_array($sql))
                                        for ($i = 0; $i < mysql_num_fields($sql); $i++)
                                            echo $rr[$i] . " ";
                                    echo "<br>";
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card-box tilebox-one cl-box">
                                ...
                                <h6 class="text-muted text-uppercase m-b-20">Pending</h6>
                                <h2 class="m-b-20"><?php echo $company['currency']; ?><span data-plugin="counterup"><?php
                                        $result = mysql_query("SELECT SUM(shipping_subtotal	) as total FROM courier WHERE book_mode='Pending' AND user='" . $_SESSION["user_type"] . "'");
                                        $row = mysql_fetch_array($result, MYSQL_ASSOC);
                                        echo $s . formato($row["total"]);
                                        ?></span></h2>
                                <span class="label label-pink">
                                    <?php
                                    $sql = mysql_query("SELECT concat(round(count( * ) *100 /(SELECT count( * ) FROM courier)) , \"%\") AS percent
								FROM courier WHERE  book_mode='Pending' AND user='" . $_SESSION["user_type"] . "' GROUP BY book_mode");
                                    while ($rr = mysql_fetch_array($sql))
                                        for ($i = 0; $i < mysql_num_fields($sql); $i++)
                                            echo $rr[$i] . " ";
                                    echo "<br>";
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card-box tilebox-one cl-box">
                                ...
                                <h6 class="text-muted text-uppercase m-b-20">Partial</h6>
                                <h2 class="m-b-20"><?php echo $company['currency']; ?><span data-plugin="counterup"><?php
                                        $result = mysql_query("SELECT SUM(shipping_subtotal	) as total FROM courier WHERE book_mode='Partial' AND user='" . $_SESSION["user_type"] . "'");
                                        $row = mysql_fetch_array($result, MYSQL_ASSOC);
                                        echo $s . formato($row["total"]);
                                        ?></span></h2>
                                <span class="label label-warning">
                                    <?php
                                    $sql = mysql_query("SELECT concat(round(count( * ) *100 /(SELECT count( * ) FROM courier)) , \"%\") AS percent
								FROM courier WHERE  book_mode='Partial' AND user='" . $_SESSION["user_type"] . "' GROUP BY book_mode");
                                    while ($rr = mysql_fetch_array($sql))
                                        for ($i = 0; $i < mysql_num_fields($sql); $i++)
                                            echo $rr[$i] . " ";
                                    echo "<br>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="process.php?action=add-pay"  class="form-horizontal" id="payment">
