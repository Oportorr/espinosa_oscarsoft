...
$sql = "SELECT c.cid, c.invoice_number, c.container_number, c.ship_name, ts.name, ci.product_name, ci.ship_qty, (c.shipping_subtotal - c.paid_amount) as balance, o.off_name  FROM  `courier_item` ci 
