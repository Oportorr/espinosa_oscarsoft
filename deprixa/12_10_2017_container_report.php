                        ...
                        <div class="card-box table-responsive">                            
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $rs = " SELECT c.cid,c.ship_name,c.s_zipcode,c.comments,c.s_add,c.paid_amount,c.shipping_subtotal,c.paid_amount, ct.city_name , st.state_name , co.country_name FROM `courier` c
