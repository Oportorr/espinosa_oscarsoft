...
<html>
    ...
    <body>
                                ...
                                <div class="modal fade" id="nuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="settings/add-new-clients/agregar.php"  id="add_entry" class="form-horizontal" method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group " id="gnombre">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" required="required" class="form-control office" name="name"  placeholder="Customer Name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="gapellido">
                                                        <label for="officer_name" class="col-sm-2 control-label">Email</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" required="required" class="form-control officer_name" value="<?php echo $rr['cemail']; ?>" name="email"  placeholder="Email">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="gapellido">
                                                        <label for="address" class="col-sm-2 control-label">Address </label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control address" required="required" name="address"   placeholder="Address ">
                                                        </div>
                                                    ...
                                                    <div class="form-group" id="gusuario">
                                                        ...
                                                        <label for="phone" class="col-sm-2 control-label" id="phone_msg">Telephone</label>
                                                        <div class="col-sm-5">
                                                    ...
                                                    <div class="form-group" required="required" id="worked">
                                                        <label for="work" class="col-sm-2 control-label">Work</label>
                                                        <div class="col-sm-5">
                                                            <input class="form-control ph_no" id="work_place" name="work" placeholder="work">							      </div>
                                                    </div>
                                                    <div class="form-group"  id="celled">
                                                        <label for="cell" class="col-sm-2 control-label">Cell</label>
                                                        <div class="col-sm-5">
                                                            <input class="form-control ph_no" id="cell_no" name="cell" placeholder="cell">							      </div>
                                                    </div>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-2">
                                                            ...
                                                            <input id="estado" type="checkbox" name="estado" value="1" ><label for="checkbox3">
                                                                Success
                                                            </label>
                                                            
                                                            </div>
                                                        </div>
                                                         <label for="cedula" class="col-sm-3 control-label"> Cedula Number </label>
                                                        <div class="col-sm-5">
                                                            <input type="text" name="cedula" id="cedula_number" class="form-control" placeholder="001-0097145-1" autocomplete=" off" required="">
                                                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="form-horizontal" id="formularioEditar">
                                                    ...
                                                    <div class="form-group" id="worked">
                                                        <label for="work" class="col-sm-2 control-label">Work</label>
                                                        <div class="col-sm-5">
                                                            <input class="form-control ph_no"  name="work" placeholder="work">							      </div>
                                                    </div>
                                                    <div class="form-group" id="celled">
                                                        <label for="cell" class="col-sm-2 control-label">Cell</label>
                                                        <div class="col-sm-5">
                                                            <input class="form-control ph_no"  name="cell" placeholder="cell">							      </div>
                                                    </div>
        ...
        $(document).on("click", "#actualizar", function (e) {
          ...
          const $btn  = $(this);
          const $form = $("#formularioEditar");
        
          // Collect + validate
          const errors = [];
        
          const name     = formVal($form, "name");
          const address  = formVal($form, "address");
          const phone    = formVal($form, "phone");
          const work     = formVal($form, "work");
          const cell     = formVal($form, "cell");
          const email    = formVal($form, "email");   // optional but format-checked if present
          const country  = formVal($form, "country");
          const state    = formVal($form, "state");
          const city     = formVal($form, "city");
          const zipcode  = formVal($form, "zipcode");
          const cedula   = formVal($form, "cedula");
        
          // Basic requireds (match your PHP checks)
          if (!name)    errors.push("Name is required.");
          if (!address) errors.push("Address is required.");
          if (!phone)   errors.push("Phone is required.");
          if (!work)    errors.push("Work is required.");
          if (!cell)    errors.push("Cell is required.");
        
          // Extra helpful checks (optional—remove if not needed)
          ...
          // if (!cedula)  errors.push("Cedula number is required.");
        
          // Visual cues
          $form.find(".is-invalid").removeClass("is-invalid");
          ["name","address","phone","work","cell"].forEach(n => {
            if (!formVal($form, n)) $form.find(`[name="${n}"]`).addClass("is-invalid");
          });
          if (email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) $form.find(`[name="email"]`).addClass("is-invalid");
        
          // If client-side validation fails, show one alert and stop
          if (errors.length) {
            alert("Please fix the following:\n\n• " + errors.join("\n• "));
            const $firstBad = $form.find(".is-invalid").first();
