							...
							<div class="row">
								...
								<div class="modal fade" id="nuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								  ...
								  <div class="form-group " id="gnombre">
									...
									<div class="col-sm-10">
                                                                            <input type="text" class="form-control name" name="Containernumber"  placeholder="Container Number" value="">
									</div>
								  </div>
								  ...
								  <div class="form-group" id="gemail">
									...
									<div class="col-sm-10">
									  <input type="text" class="form-control notes" name="notes"  placeholder="Notes Field">
									</div>
								  </div>					  
								...
								<!--Cuerpo del modal aquí el formulario-->
								  ...
								  <div class="form-group" id="Enombre">
									<label for="number" class="col-sm-2 control-label">Container Number </label>
									<div class="col-sm-10">
									  <input type="text" class="form-control name" name="containernumber" placeholder="Container Number">
									</div>
								  </div>
								  ...
								  <div class="form-group" id="Etelefono">
									<label for="notes" class="col-sm-2 control-label">Notes </label>
									<div class="col-sm-10">
									  <input class="form-control notes" name="notes" placeholder="Notes Field ">							
									</div>
								  </div>
