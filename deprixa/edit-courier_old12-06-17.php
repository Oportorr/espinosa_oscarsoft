...
if ($count > 0) {
 ...
 <select name="Invoiceno"  id="Invoiceno"  class="status form-control" value="" >                                                                        
                                                                                    <?php                                                                              
                                                                                    $getdd = mysql_query("SELECT `off_name`,`id` FROM `offices` where `estado`=1 ");
                                                                                    while ($row1 = mysql_fetch_array($getdd)) {
                                                                                        ?>
                                                                                        <option value="<?php echo $row1['id']; ?>" <?php
                                                                                        if ($row1['id'] == $invice_no) {
                                                                                            echo "selected";
                                                                                        }
...
?>
	...
	<?php } ?>
	    ...
	    <?php } ?>
	    								...
	    								<input  type="hidden" id="product_price" class="product_price" name="product[<?php echo $product_row; ?>][product_price]" value="<?php echo $item['product_price']; ?>"/>

	    							    </td>

	    							    <td><input  type="text" class="form-control ship_qty" id="ship_qty"  name="product[<?php echo $product_row; ?>][ship_qty]" value="<?php echo $item['ship_qty']; ?>" placeholder="0" onChange=""/></td>
	    							    <td><input  type="text" class="form-control discount" id="discount1"  name="product[<?php echo $product_row; ?>][discount]" value="<?php echo $item['discount']; ?>" placeholder="%" onChange=""/></td>
	    							    <td><input  type="text" readonly="true" class="form-control sub_total"  id="sub_total1"  name="product[<?php echo $product_row; ?>][sub_total]" value="<?php echo $item['sub_total']; ?>" placeholder="0,00" onChange="" /></td>
	...
	<?php } ?>
						...
						<div class="row">
							...
							<div>
								...
								<input type="text" class="form-control" name="Packupdate" value="<?php echo $pick_date; ?>"  id="editdatepicker" readonly="true">
...
<?php } ?>
						html += '</select></td>';
						html += '<input  type="hidden" id="product_price' + row + '" class="product_price" name="product[' + row + '][product_price]"/>';
   ...
   html += '<td><select class="form-control product_status" id="product_status' + row + '"  name="status[' + row + '][status]" >';
   <?php
$q_office = mysql_query("SELECT * FROM `offices` where `estado`=1");
while ($office_row = mysql_fetch_array($q_office)) {
    ?>
                html += '<option value="<?php echo $office_row['id']; ?>" <?php if($office_row['id'] == '54'){ echo 'selected';} ?>><?php echo $office_row['off_name']; ?></option>';
<?php } ?>
    html +='</select></td>';
				    ...
				    //		document.getElementsByName('product_type')[0].id = 'product_type' + i;
				    //		document.getElementsByName('ship_qty')[0].id = 'ship_qty' + i;
				    //		document.getElementsByName('discount')[0].id = 'discount' + i;
				    //		document.getElementsByName('sub_total')[0].id = 'sub_total' + i;
				    //		document.getElementsByName('product_price')[0].id = 'product_price' + i;
				    //
				    //
				    //	    }
